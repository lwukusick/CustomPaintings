package com.lwukusick.custom_painting.entity.render;
...
public class RenderCustomPainting extends Render<EntityCustomPainting> {
    /*
    private static final ResourceLocation CUSTOM_PAINTING_TEXTURES = new ResourceLocation("textures/entity/custom_painting/custom_painting.png");

    public RenderCustomPainting(RenderManager renderManager) {
        super(renderManager);
    }
    ...
    public void doRender(EntityCustomPainting entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        PaintingType paintingtype = PaintingType.KEBAB;
        float f = 0.0625F;
